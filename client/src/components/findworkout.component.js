        ...
        return (
            <div>
                ...
                <div>
                    ...
                    <form>
                        <center> <input type='text' className="inputfield" placeholder='Workout ID' onChange={this.getValue} /></center>
                        <center><button className="button" text-align="center" type="submit" onClick={this.handleSubmit}>Search Workout</button></center>
                    </form>
                </div>
                <div>
                    <div>
